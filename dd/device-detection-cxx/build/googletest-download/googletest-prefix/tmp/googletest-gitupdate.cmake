...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v1.10.x"
  WORKING_DIRECTORY "/b1/common/51degfork/device-detection-go/dd/device-detection-cxx/build/googletest-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/v1.10.x")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "v1.10.x")
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/b1/common/51degfork/device-detection-go/dd/device-detection-cxx/build/googletest-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/b1/common/51degfork/device-detection-go/dd/device-detection-cxx/build/googletest-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
